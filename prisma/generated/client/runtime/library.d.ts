...
> = P extends FluentOperation ?
    ...
    & PrismaPromise<
      DynamicModelExtensionFnResultBase<TypeMap, M, A, P, ClientOptions> | Null
    >
  : PrismaPromise<
...
export declare type ExtractGlobalOmit<Options, ModelName extends string> =
  Options extends {
    omit: {
      ...
      & {
        [
          K in keyof S | keyof I as (S & I)[K] extends
            false | undefined | Skip | null ? never : K
...
export declare type OmitValue<Omit, Key> = Key extends keyof Omit ? Omit[Key]
  : false;
...
export declare type RawQueryArgs = Sql | UnknownTypedSql | [
  query: string,
  ...values: RawValue[],
];
